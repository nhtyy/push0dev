  ...
  return (
    <div className="about">
      ...
      <h4 className="about-text" style={{ fontWeight: "normal" }}>
        ...
        like working on backend and stuff related to distributed systems in
        general. Here you will find (potentialy incoherent) writings and info
        dumps about things I find interesting.
      </h4>
    </div>
  );
}
