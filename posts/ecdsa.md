...
- ## Implementation
  ...
  Without a recovery id value, like the one used in Ethereum $$\sigma' = (r, s, v)$$, or further communication, it is only possible to narrow down the possible public keys [(addresses)](https://www.geeksforgeeks.org/how-to-create-an-ethereum-wallet-address-from-a-private-key/#) to a limited number. Recovery ids are sometimes used to differentiate between additive inverses but i believe in ecerecover youre point must have a y value in some range
